...
export default class MovieCard extends Component {
  ...
  render () {
    return (
      <React.Fragment>
        <div id="current" ref="current" style={{
          transform: `perspective( 600px ) translate3d( 0, -2px, 0 ) scale(1.1) rotateX(${this.state.degX
                        }) rotateY(${this.state.degY})`,
          left: 40,
          top: 40
        }} className="ItemCard" onMouseMove={(evt) => this.movehandler(evt)} onMouseLeave={(evt) => this.leaveHandler()}
